...
const {estadoAprobacion,obtenerAprobacionesPorTecnico, obtenerInformesPendientes,aprobarInforme, enviarParaAprobacion, obtenerAprobadores, rechazarInforme} = require('../controllers/aprobaciones.controller');
...
router.post('/rechazar', rechazarInforme);
