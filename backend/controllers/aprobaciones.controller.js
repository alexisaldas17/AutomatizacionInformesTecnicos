...
-- Informes desde Informes_Componentes
SELECT 
    ai.ID AS idAprobacion,
    ai.ID_INFORME,
    ai.ID_APROBADOR,
    ...
    ic.TECNICO AS nombreTecnico,
    ic.ARCHIVO AS rutaPdf,
    a.NOMBRE AS nombreAprobador,
    ic.USUARIO,
    ic.MAIL,
    ic.NOMBRE AS nombreArchivo,
    'Parte' AS tipoOrigen
FROM 
    Aprobaciones_Informe ai
INNER JOIN 
    Informes_Componentes ic ON ai.ID_INFORME = ic.ID
INNER JOIN 
    Autenticacion a ON ai.ID_APROBADOR = a.ID
WHERE 
    ai.ID_TECNICO = @idTecnico;
...
async function notificarTeams(nombreArchivo, nombreTecnico) {
  const webhookUrl =
    "https://bgrecuador.webhook.office.com/webhookb2/e4464fa7-bfe5-4e53-882b-4d67ef8e94cb@5403bb85-6bc3-495d-8a5e-1a61c622dd74/IncomingWebhook/c6bacac134d141cb832932783ba8a2d5/b861c152-81d8-4d1e-acfc-70b5b7cd0936/V20e489Xjwmr9Ky7_6pR-0HxUu7DKPwxfluqt8oVieTas1";
...
async function notificarAprobacionTeams(
  nombreArchivo,
  nombreTecnico,
  comentario
) {
