...
import { verPDF, verPDFPartes } from '../../services/pdfService';
...
const HistorialInformesPartes = () => {
 ...
 const buscarInformes = useCallback(async () => {
    try {
      const response = await axios.get('http://172.20.70.113:3000/api/historial/partes', {
        params: filtros
      });
                ...
                {resultadosPaginados.map((informe) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <IconButton
                        onClick={() => verPDFPartes(informe.NOMBRE)}
...
export default HistorialInformesPartes;
