...
export const generarPDFenMemoria = async (formData) => {
  try {
    ...
    /**
  * Renderiza contenido HTML con formato (negrita, cursiva) palabra por palabra en una sola línea usando jsPDF.
  * Evita saltos de línea innecesarios y ajusta el texto al ancho disponible.
  */
